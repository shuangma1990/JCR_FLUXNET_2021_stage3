...
%       wbmatrix(i,:) = [WB.PAW WB.PUW WB.SWE];
      ...
      outdata = {mod.NBE,mod.NBEano,mod.rh_ch4,mod.ABGB,mod.ET,mod.SCF,...
          mod.ch4_co2,...%mod.ch4_co2,mod.soil_moist,mod.fV,mod.fW,mod.fT,mod.fCH4,mod.fTch4,...
          ...
          mod.GPP,mod.rh_co2,mod.NPP,mod.leafC,mod.woodC,mod.rootC,mod.SOM}; % ,mod.SOM,mod.LAI,mod.leafC,mod.rh_co2,mod.rh_ch4,mod.soil_moist,mod.NPP,mod.Ra
...
% save plots to figures folder
      ...
      for o=1:(length(varnames)-21)
          nfrow=6; % number of figure rows
          nfcol=5; % number of figure cols
          if o==4 || o==6
              yhat = median(outdata{o}(:,1:(end-1)),1)';
          else
