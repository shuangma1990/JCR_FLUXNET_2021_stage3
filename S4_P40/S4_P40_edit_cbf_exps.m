% P40 is the same as P25 but uses main branch DALEC1100 for debugging and testing
nop = 'S4_P40'; % P21 first test of min max_value field in PEQs, after correcting JCR C balance,
