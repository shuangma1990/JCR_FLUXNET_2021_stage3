...
odir = paste0('/Users/shuangma/RESEARCH/WORKFLOW/JCR_FLUXNET_2021_stage3/',projectname,'/S6_scatterplot_single_site/')
...
# for (iexp in c(1, 2, 6, 7, 8)){
  pdf_name_list[[1]] <- paste0("S6_all_sites_exp",iexp,"_MCMC",percentilv,siteids[s],".pdf") # option 1
  pdf_name_list[[2]] <- paste0("S6_4yr_sites_exp",iexp,"_MCMC",percentilv,siteids[s],".pdf")
  pdf_name_list[[3]] <- paste0("S6_5yr_sites_exp",iexp,"_MCMC",percentilv,siteids[s],".pdf")
  # pdf_name_list[[1]] <- paste0("S6_1-4m_sites_exp",iexp,".pdf") # option 2
    ...
    for (i in 1){ # change input here # option 2
      ...
      varnames = c("CH4", "ET", "NBE","ABGB", "SCF","EWT","rhch4_rhco2","rhco2_rh","SM_LY1","SM_LY2",
                   "H2O_LY1","H2O_LY2","an_ch4_c_ratio","an_co2_c_ratio") # P44 and newer
