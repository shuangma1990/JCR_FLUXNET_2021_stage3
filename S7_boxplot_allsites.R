projectfoldername<-'JCR_FLUXNET_2021_stage3'
projectname<-'/S4_P25'
...
idir = paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,projectname,'/output/')
odir = paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,projectname,'/figures/A1_boxplot')

dir.create(odir)
#### plot hist####
adjnum=1
siteinfo<-list()
siteinfo[[1]] <- read.csv(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/S2_LATLON2CBF_edited.csv'))
siteinfo[[2]] <- read.csv(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/siteid_4yrs.csv'))
siteinfo[[3]] <- read.csv(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/siteid_5yrs.csv'))
...
for (isiteinfo in 1:3){
  siteids <- (siteinfo[[isiteinfo]]$SITE_ID)
  ...
  varnames = c("CH4", "ET", "NBE","ABGB", "SCF")
    for (s in 1:(length(siteids))){
      # iexp = 3
        ...
        filename = list.files(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/S3/met/'),pattern=paste0(siteids[s]))
        met <- read.csv(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/S3/met/',filename))
        met$sitename<-rep(siteids[s],nrow(met))
        filename = list.files(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/S3/obs/'),pattern=paste0(siteids[s]))
        obs <- read.csv(paste0('/Users/shuangma/RESEARCH/WORKFLOW/',projectfoldername,'/S3/obs/',filename))
  ...
  pdf(paste0(odir, "pdf_boxplot", iexp, "_sitecollection",isiteinfo,".pdf"),
