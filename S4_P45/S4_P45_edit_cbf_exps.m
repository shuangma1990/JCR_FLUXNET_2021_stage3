...
nop = 'S4_P45'; % P21 first test of min max_value field in PEQs, after correcting JCR C balance,
...
% -- -- -- --  get CBF_exps ready and submit to gattaca  -- --  --  -- 
    [CBF_cell,string_CBF_cell] = edit_fluxnetexps_used_in_P45(CBF_exp,CBF_exp_noobs); 
