...
%       wbmatrix(i,:) = [WB.PAW WB.PUW WB.SWE];
      ...
      outdata = {mod.NBE,mod.NBEano,mod.rh_ch4,mod.ABGB,mod.ET,mod.SCF,mod.GPP,     mod.swe,...
          ...
          mod.Rh,mod.rh_co2,mod.rh_co2_an,mod.NPP,mod.labC,mod.leafC,mod.woodC,mod.rootC,mod.SOM}; % ,mod.SOM,mod.LAI,mod.leafC,mod.rh_co2,mod.rh_ch4,mod.soil_moist,mod.NPP,mod.Ra
