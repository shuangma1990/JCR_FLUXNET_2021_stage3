...
nop = 'S4_P32'; % P21 first test of min max_value field in PEQs, after correcting JCR C balance,
...
%               P26 is the first Project run with corrected hydro stuctures
%               P29 run with Paul's fix Jul29 Friday
%               P30 is the same as P29 except S_fv range is 1-100
%               P31 synced Paul's drainage fix, and Paul's fmax fix, S_fv
%               range [1-100]
%               P32 uses main branch 1100, hydrology is the same as my branch
%               but in addition has frozen water, one instead of two k_PAW k_PUW,
%               EDC is not working,
%               energy balance is not working, C allocation untested,
%               trying to just see if hydrology make sense
